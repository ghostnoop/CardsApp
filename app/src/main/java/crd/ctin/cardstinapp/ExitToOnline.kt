...
import kotlinx.android.synthetic.main.activity_exit_toonline.*

private var url: String = ""

class ExitToOnline : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_exit_toonline)
        url = intent.extras!!.getString("url")!!

        webView.webViewClient = SourceLoad()
